...
public class DbWhStockItem extends SQLiteOpenHelper {  // Db Helper  
public static final String TABLE_NAME = "DbWhStockItem";
public static final String _CREATE = DbWhStockItemC.SQL_CREATE;
private static final int    _DB_VERSION             = 1;

    public DbWhStockItem(@NonNull Context context) {
