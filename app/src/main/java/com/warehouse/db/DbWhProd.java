...
public class DbWhProd extends SQLiteOpenHelper {  // Db Helper  
public static final String TABLE_NAME = "DbWhProd";
public static final String _CREATE = DbWhProdC.SQL_CREATE;
private static final int    _DB_VERSION             = 1;

    public DbWhProd(@NonNull Context context) {
