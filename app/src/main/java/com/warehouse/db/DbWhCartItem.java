...
public class DbWhCartItem extends SQLiteOpenHelper {  // Db Helper  
public static final String TABLE_NAME = "DbWhCartItem";
public static final String _CREATE = DbWhCartItemC.SQL_CREATE;
private static final int    _DB_VERSION             = 1;

    public DbWhCartItem(@NonNull Context context) {
