...
public class DbWhCart extends SQLiteOpenHelper {  // Db Helper  
public static final String TABLE_NAME = "DbWhCart";
public static final String _CREATE = DbWhCartC.SQL_CREATE;
private static final int    _DB_VERSION             = 1;

    public DbWhCart(@NonNull Context context) {
