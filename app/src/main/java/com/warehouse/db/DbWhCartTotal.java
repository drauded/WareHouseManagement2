...
public class DbWhCartTotal extends SQLiteOpenHelper {  // Db Helper  
public static final String TABLE_NAME = "DbWhCartTotal";
public static final String _CREATE = DbWhCartTotalC.SQL_CREATE;
private static final int    _DB_VERSION             = 1;

    public DbWhCartTotal(@NonNull Context context) {
